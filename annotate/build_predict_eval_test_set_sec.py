...
def run():
    templates = DataLoader.load_file_csv("resourcen/evaluation_test_set.csv")#.drop_duplicates(subset=['HATE_SPEECH'])
...
def check_fine_tuned(templates):
    ...
    model_path = "resources/trained_models/connan/file1000/output/checkpoint-1000"
    ...
    #DataLoader.save_df_to_csv(templates, 'predict_evaluation_test_set_v3.csv')
    DataLoader.save_df_to_csv(templates, 'resources/predict_evaluation_test_set_round_2_70_30_05_05.csv')
